...
def dashboard(top_note, heart_note, base_note):
    ...
    heatmap_data, heatmap = gen_heatmap(heatmap_data)
...
tb_data, tb_cols, heatmap_data, heatmap = dashboard([], [], [])
...
app.layout = html.Div([
    ...
    dcc.Input(id="heatmap_status", value=0),        
...
#     return tb_data, heatmap, heatmap
...
def heatmap_btn_fun(clicks, status, heatmap_data, heatmap):
    print('Bug - default status is 1')
    ...
    # print(heatmap_data)
    # dict        
    # print(heatmap_data, type(heatmap_data))
    print('Evolve, add global class')
    ...
    heatmap['layout']['xaxis']['title']['text'] = x_note
    heatmap['layout']['yaxis']['title']['text'] = y_note


    heatmap = go.Figure(heatmap, layout=layout)   
    print(type(heatmap), heatmap)
...
def version_note():
    ...
    # - Optimize, make width of data table as 100%
